...
#ifndef RCPP_NS-GMWM_RCPPEXPORTS_H_GEN_
#define RCPP_NS-GMWM_RCPPEXPORTS_H_GEN_
...
namespace NS-GMWM {
    ...
    namespace {
        void validateSignature(const char* sig) {
            ...
            require("NS-GMWM", Rcpp::Named("quietly") = true);
            typedef int(*Ptr_validate)(const char*);
            static Ptr_validate p_validate = (Ptr_validate)
                R_GetCCallable("NS-GMWM", "_NS-GMWM_RcppExport_validate");
            if (!p_validate(sig)) {
                throw Rcpp::function_not_exported(
                    "C++ function with signature '" + std::string(sig) + "' not found in NS-GMWM");
            }
        }
    }
    ...
    inline double of_dyn(arma::vec& theta, arma::mat& nu_hat, arma::vec& x, arma::vec& tau, arma::mat& Omega, bool WN, bool QN, unsigned int AR1) {
        ...
        if (p_of_dyn == NULL) {
            ...
            p_of_dyn = (Ptr_of_dyn)R_GetCCallable("NS-GMWM", "_NS-GMWM_of_dyn");
        }
    ...
    inline arma::vec grad_of_dyn(arma::vec& theta, arma::mat& nu_hat, arma::vec& x, arma::vec& tau, arma::mat& Omega, bool WN, bool QN, unsigned int AR1) {
        ...
        if (p_grad_of_dyn == NULL) {
            ...
            p_grad_of_dyn = (Ptr_grad_of_dyn)R_GetCCallable("NS-GMWM", "_NS-GMWM_grad_of_dyn");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
...
#endif // RCPP_NS-GMWM_RCPPEXPORTS_H_GEN_
